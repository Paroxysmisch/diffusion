...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, required=True, help="Path to the Lightning checkpoint (.ckpt)")
    parser.add_argument("--out", type=str, default="./outputs", help="Directory to save images")
